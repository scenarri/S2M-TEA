...
def resnet5(beta_value:float=25.0, decays=[1.0, 0.85, 0.65, 0.15],pretrained: bool = False, progress: bool = True,**kwargs: Any):
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet('resnet18', BasicBlock, [1, 1, 1, 1], decays, pretrained, progress,beta_value,
                   **kwargs)
