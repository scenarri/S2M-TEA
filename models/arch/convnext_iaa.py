...
class CNBlock(nn.Module):
    ...
    def forward(self, input: Tensor) -> Tensor:
        ...
        result = result * self.decay + input
        #result += input
        return result
        ...
        **kwargs: Any,
        ...
        for cnf in block_setting:
            ...
            for i in range(cnf.num_layers):
                ...
                stage.append(block(cnf.input_channels, layer_scale, sd_prob, beta_value, decays[0]))
                stage_block_id += 1
...
def _convnext(
    ...
    **kwargs: Any,
    ...
    model = ConvNeXt(block_setting, stochastic_depth_prob=stochastic_depth_prob, beta_value=beta_value, decays=decays, **kwargs)
...
def convnext_tiny_iaa(*,beta_value:float=25.0, decays=[1.0, 0.85, 0.65, 0.15], weights: Optional[ConvNeXt_Tiny_Weights] = None, progress: bool = True, **kwargs: Any) -> ConvNeXt:
    ...
    return _convnext(block_setting, stochastic_depth_prob, weights, beta_value, decays, progress, **kwargs)
